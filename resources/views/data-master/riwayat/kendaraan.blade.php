            ...
            <div class="container-fluid">
                <form action="/riwayat-kendaraan" method="get">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Cari menggunakan Kode Kegiatan"
                            aria-label="Recipient's username" aria-describedby="button-addon2" name="kode_kegiatan">
